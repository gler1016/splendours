      ...
      <Box>
        ...
        <Box className="flex flex-col w-full gap-y-12">
          ...
          {isMobile ? (
                ...
                <Box className="flex w-full gap-3">
                  <Box className="w-1/2">
                    <Box>
                      ...
                      >
                        we create experiences. Our portfolio showcases a
                        captivating collection of projects where natural stone
                        has breathed life into Melbourne homes and businesses.
                      </Typography>
                    </Box>
                  ...
                  <Box className="flex w-1/2">
                    ...
                    >
                      Explore a curated selection of projects, each a testament
                      to natural stone's enduring beauty and versatility. From
                      modern kitchen renovations featuring captivating stone
                      splashbacks to stunning outdoor living spaces paved with
                      timeless elegance, discover how we've collaborated with
                      clients to translate their visions into reality.
                    </Typography>
                  </Box>
                </Box>
              </Box>
            ...
            <Box className="flex flex-col gap-y-6 px-20">
              ...
              >
                {/* Left Typography Box */}
                <Box
                  className={isMobile ? "w-full" : isTablet ? "w-2/5" : "w-1/4"}
                >
                  <Typography
                    variant="h3"
                    color="#FFFFFF"
                  ...
                  >
                    We create experiences. Our portfolio showcases a captivating
                    collection of projects where natural stone has breathed life
                    into Melbourne homes and businesses.
                  </Typography>
                </Box>
                ...
                <Box
                  className={
                    isMobile ? "w-full" : isTablet ? "w-3/5" : "flex w-2/5"
                  }
                >
                  <Typography
                    variant="h3"
                  ...
                  >
                    Explore a curated selection of projects, each a testament to
                    natural stone's enduring beauty and versatility. From modern
                    kitchen renovations featuring captivating stone splashbacks
                    to stunning outdoor living spaces paved with timeless
                    elegance, discover how we've collaborated with clients to
                    translate their visions into reality.
                  </Typography>
                </Box>
              </Box>
            </Box>
          ...
          {isMobile ? (
            <Box
              ...
              sx={{
                backgroundImage:
                  "url(images/Portfolio/Inspiration/Mobile/background-mobile.svg)", // Add your image path here
            ...
            >
              <Box className="flex w-full">
                <Box className="flex flex-col w-full items-center justify-center">
                  ...
                  >
                    Whether you&apos;re seeking classic sophistication or a
                    burst of contemporary flair, our portfolio offers a wealth
                    of inspiration.
                  </Typography>
                </Box>
              </Box>
            ...
            >
              <Box className="flex w-full justify-between mb-12">
                ...
                <Box className="flex w-1/3 items-center mb-12">
                  ...
                  >
                    Whether you're seeking classic sophistication or a burst of
                    contemporary flair, our portfolio offers a wealth of
                    inspiration.
                  </Typography>
                </Box>
              </Box>
          ...
          {isMobile ? (
            <Box
              ...
              sx={{
                backgroundImage:
                  "url(images/Portfolio/Inspiration/Mobile/background-mobile.svg)",
                backgroundSize: "cover",
                backgroundPosition: "center",
            ...
            >
              <Box className="flex w-full">
                <Box className="flex flex-col w-full items-center justify-center">
                  ...
                  >
                    Delve deeper into the specific stones used in each project,
                    allowing you to discover the unique textures and colours
                    each natural stone offers.
                  </Typography>
                </Box>
              </Box>
            ...
            <Box
              ...
              sx={{
                backgroundImage:
                  "url(images/Portfolio/materials/background.jpg)",
                backgroundSize: "cover",
                backgroundPosition: "center",
                backgroundRepeat: "no-repeat",
              }}
            ...
            <Box className="px-3">
              <Box className="flex flex-col items-center w-full gap-y-5">
                ...
                <Box className="flex w-4/5 items-center">
                  ...
                  >
                    Beyond the visual appeal, each project description
                    highlights the practical benefits of using natural stone.
                    Discover how stone&apos;s durability enhances functionality,
                    its timeless style adds lasting value, and its sustainable
                    nature creates an eco-conscious space.
                  </Typography>
                </Box>
              </Box>
            </Box>
          ) : (
            <Box className="flex w-full justify-between px-20">
              ...
              <Box className="flex w-1/3 items-center">
                ...
                >
                  Beyond the visual appeal, each project description highlights
                  the practical benefits of using natural stone. Discover how
                  stone's durability enhances functionality, its timeless style
                  adds lasting value, and its sustainable nature creates an
                  eco-conscious space.
                </Typography>
              </Box>
            </Box>
              ...
              <Box className="flex w-full justify-between">
                ...
                <Box className="flex flex-col w-1/3 items-center gap-3">
                  ...
                  >
                    Beyond the visual appeal, each project description
                    highlights the practical benefits of using natural stone.
                    Discover how stone's durability enhances functionality, its
                    timeless style adds lasting value, and its sustainable
                    nature creates an eco-conscious space.
                  </Typography>
                  {isTablet ? (
          ...
          {isMobile ? (
            <Box className="flex w-full flex-col relative items-center justify-center text-white mb-9">
            ...
            <Box className="flex w-full flex-col relative items-center justify-center text-white mb-16">
              <Box className="flex justify-center items-center w-full">
                <Image
