        ...
        >
            ...
            {isMobile ?
                ...
                <Box className="flex flex-col px-20">
                    <Typography variant="body1" color="white" sx={{ fontFamily: "Chronicle Display", fontSize: { xs: '20px', sm: '5vw', lg: '50px' }, fontWeight: 700, lineHeight: 1.1, opacity: '10%' }}>SAME DAY QUOTES</Typography>
                    <Typography variant="body1" color="#DBC6BC" sx={{ fontFamily: "Chronicle Display", fontSize: { xs: '20px', sm: '5vw', lg: '50px' }, fontWeight: 700, lineHeight: 1.1, textAlign: 'center' }}>STATE OF THE ART SHOWROOM</Typography>
                    <Typography variant="body1" color="white" sx={{ fontFamily: "Chronicle Display", fontSize: { xs: '20px', sm: '5vw', lg: '50px' }, fontWeight: 700, lineHeight: 1.1, opacity: '10%', textAlign: "right" }}>SUPPLY & INSTALL PACKAGES</Typography>
                </Box>}
...
>
    ...
    >
        <img className="absolute left-[600px] mt-80 z-50  items-center lg:flex hidden  justify-center "
            src="images/Home/home_stairs.png"
            alt="3D Viewer"
            style={{
                maxWidth: '500px', // Limit width to match the proportions in the reference image
                height: 'auto',
                borderRadius: '10px',
