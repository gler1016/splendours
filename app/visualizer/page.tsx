        ...
        <Suspense fallback={<Loader />}>
            {
                modelPath === '/models/chimney.glb' ? (
                    ...
                    <House
                        ...
                        selectedHeight={selectedHeight}
                    />
                ) : modelPath === '/models/Kitchen_splashback.glb' ? (
                    <Kitchen_splashback
                        modelPath={modelPath}
                        selectedBaseColor={selectedBaseColor}
                        selectedArm={selectedArm}
                        ...
                        selectedHeight={selectedHeight}
                    />
                ) : modelPath === '/models/Vertical_wall_bar.glb' ? (
                    <Vertical_wall_bar
                        modelPath={modelPath}
                        selectedBaseColor={selectedBaseColor}
                        selectedArm={selectedArm}
                    ...
                    //     />
                    // ) 
                    : modelPath === '/models/Patios_pergolas.glb' ? (
                        <Patios_pergolas
                            modelPath={modelPath}
                            selectedBaseColor={selectedBaseColor}
                            selectedArm={selectedArm}
                        ...
                        <Bathroom
                            ...
                            selectedHeight={selectedHeight}
                        />
                    ) : modelPath === '/models/Outside_Chimney.glb' ? (
                        <Outside_Chimney
                            modelPath={modelPath}
                            selectedBaseColor={selectedBaseColor}
                            selectedArm={selectedArm}
                        ...
                        <Shower
                            ...
                            selectedHeight={selectedHeight}
                        />
                    ) : modelPath === '/models/Entry_wall.glb' ? (
                        <Entry_wall
                            modelPath={modelPath}
                            selectedBaseColor={selectedBaseColor}
                            selectedArm={selectedArm}
                            ...
                            selectedHeight={selectedHeight}
                        />
                    ) : modelPath === '/models/beachport.glb' ? (
                        <Beachport
                            modelPath={modelPath}
                            selectedBaseColor={selectedBaseColor}
                            selectedArm={selectedArm}
...
const App: React.FC = () => {
    ...
    const models = ['/models/chimney.glb', '/models/house.glb', '/models/Kitchen_splashback.glb', '/models/Vertical_wall_bar.glb', '/models/Patios_pergolas.glb', '/models/bathroom.glb', '/models/Outside_Chimney.glb', '/models/Shower.glb', '/models/Entry_wall.glb', '/models/beachport.glb'];
