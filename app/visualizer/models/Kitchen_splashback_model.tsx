...
const Kitchen_splashback = ({
  ...
  }, [gltf, selectedBaseColor, selectedArm, selectedNormal, selectedHeight, zoomStatus, rotateStatus, defaultArm, defaultBaseColor, defaultHeight, defaultNormal, textures.baseColor]);
