...
export function GreenServiceBtn({
  label,
  icon,
  className,
  ...
  return (
    <div className="relative py-6 flex items-center justify-center ">
      <Modal>
        <ModalTrigger
          className={cn(
            "bg-color text-customColor flex items-center justify-center gap-2 group/modal-btn relative",
            className
          )}
          onClick={onClick} // Pass onClick to ModalTrigger
        >
          {/* Label */}
          <span className="group-hover/modal-btn:translate-x-40 text-[13px] font-light flex text-[#DBC6BC] justify-between items-center gap-6 text-center transition duration-500">
            {label} {icon && (
              <Image
                src={icon}
                width={24}
