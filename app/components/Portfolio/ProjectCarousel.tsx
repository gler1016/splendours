                ...
                >
                    {data.resources.map((resource: Resource, index: number) => (
                        ...
                        >
                            ...
                            <a
                                className="h-full w-full aspect-square block absolute top-0 left-0 z-10"
                            >
                                <Box className="w-1/2">
                                    <h3 className="text-white py-6 px-3 mx-auto text-start text-[30px]" style={{ fontFamily: 'Chronicle Display', lineHeight: '0.8' }}>
