...
export function GreenAnimationBooking({label,icon,className} : AnimatedModalDemoProps) {
 
  return (
    <div className="relative py-8 px-8 w-[500px] h-[53px] flex items-center justify-center gap-10">
      <Modal>
